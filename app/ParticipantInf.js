...
export default function ParticipantInf() {
    ...
    const validate=()=>{
        ...
        else if (isNaN(formData.age) || (formData.age<18 || formData.age>99)) newErrors.age='Enter a valid age between 18 to 99';
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <div className="participant-box">
                ...
                <input type="number" id="age" name="age" placeholder='enetr your age' value={formData.age} onChange={handleChange}></input>
